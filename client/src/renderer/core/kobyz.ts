...
class Kobyz extends Lifeform implements I_Plant {
  name!: I_Plant["name"];
  code!: I_Plant["code"];
  cost!: I_Plant["cost"];
  ...
  async initAttributes() {
    ...
    this.images = {
      idle: (await import("@/assets/images/plants/kobyz/idle.webp")).default,
      walk: null,
      attack: null,
      death: null,
    };
...
function getKobyz() {
  ...
  return new Kobyz(defaultInput);
}

export { getKobyz, Kobyz };
